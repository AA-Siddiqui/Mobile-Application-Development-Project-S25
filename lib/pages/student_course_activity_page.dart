        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              if (DateTime.parse(data["deadline"]).compareTo(DateTime.now()) <
                  0)
                Obx(() => _buildTile(
              ...
              Obx(() {
                if (stateController.files.isNotEmpty) {
                  return Skeletonizer(
                    ...
                    child: SizedBox(
                      ...
                      child: ListView.builder(
                          ...
                          itemCount: stateController.files.length,
                          itemBuilder: (context, index) {
                            return Container(
                              ...
                              child: Column(
                                children: [
                                  Text(
                                    stateController.files[index]["name"],
